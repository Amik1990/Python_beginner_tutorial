...
# Inicializace okna
window = tk.Tk()
window.title("Test základů Pythonu")
...
# Vytvoření widgetů
question_label = tk.Label(window, textvariable=question_text, font=("Arial", 16))
question_label.pack(pady=20)

option_buttons = []
for i in range(4):
    button = tk.Button(window, text="", font=("Arial", 12), width=40, height=2, command=lambda i=i: check_answer(chr(ord('a') + i)))
